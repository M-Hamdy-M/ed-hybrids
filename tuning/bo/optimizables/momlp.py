...
from models.hybrid import MOMLP

import ConfigSpace as CS
import torch

class OptimizableMOMLP(OptimizableModel):
    def __init__(self, name="MOMLP", device=None, verbose=0, **kwargs):
        super().__init__(MOMLP, {
    ...
    def _get_bounds(self):
        ...
        "output_direct_link": CS.CategoricalHyperparameter(
                "output_direct_link", (True, False), default_value=True),
        }
